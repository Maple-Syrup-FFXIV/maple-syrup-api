...
namespace maple_syrup_api.Migrations
{
    ...
    [Migration("20210817202742_OriginalRequirement")]
    partial class OriginalRequirement
    {
            ...
            modelBuilder.Entity("maple_syrup_api.Models.EventRequirement", b =>
                {
                    ...
                    b.Property<List<int>>("OriginalClassRequirement")
                        .HasColumnType("integer[]");

                    b.Property<List<int>>("OriginalDPSTypeRequirement")
                        .HasColumnType("integer[]");

                    b.Property<List<int>>("OriginalPerJobRequirement")
                        .HasColumnType("integer[]");
